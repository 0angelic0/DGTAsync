#
#  Be sure to run `pod spec lint DGTAsync.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "0angelic0"
  # s.authors            = { "0angelic0" => "pisit@digitopolisstudio.com" }
  # s.social_media_url   = "http://twitter.com/0angelic0"
  ...
  s.source       = { :git => "https://github.com/0angelic0/DGTAsync", :tag => "0.0.1" }
